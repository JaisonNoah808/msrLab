...
# Getting the weeks from the datetime object we converted
extractedData["Week"] = extractedData["Date"].dt.isocalendar().week # Week of the year
...
for author in authors:
    ...
    # Plotting the data
    plt.scatter(theWeeksAuthor, theFilesAuthor, c=theColor, alpha=0.5, edgecolor="black", label=author)
